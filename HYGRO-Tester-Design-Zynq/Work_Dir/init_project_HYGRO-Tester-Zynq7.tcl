...
#
# init_project_HYGRO-Tester-Zynq7.tcl: Tcl script for re-creating project 'HYGRO-Tester-Zynq7'
#
# Generated by Vivado on Wed Apr 19 20:21:54 EDT 2023
...
#
# 1. This project restoration tcl script (init_project_HYGRO-Tester-Zynq7.tcl) that was generated.
#
...
#
#    "/home/<wadir>/fpga-iic-hygro-tester-3/HYGRO-Tester-Design-Zynq/Constraints/a-Zybo-Z7-Master-timing.xdc"
#    "/home/<wadir>/fpga-iic-hygro-tester-3/HYGRO-Tester-Design-Zynq/Constraints/z-Zybo-Z7-Master-physical.xdc"
#
#*****************************************************************************************
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/../Constraints/a-Zybo-Z7-Master-timing.xdc"]"\
 "[file normalize "$origin_dir/../Constraints/z-Zybo-Z7-Master-physical.xdc"]"\
  ]
  foreach ifile $files {
...
set _xil_proj_name_ "HYGRO-Tester-Zynq7"
...
set script_file "init_project_HYGRO-Tester-Zynq7.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/HYGRO-Tester-Zynq7"]"
...
set file "[file normalize "$origin_dir/../Constraints/a-Zybo-Z7-Master-timing.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/../Constraints/a-Zybo-Z7-Master-timing.xdc"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property -name "file_type" -value "XDC" -objects $file_obj

# Add/Import constrs file and set constrs file properties
set file "[file normalize "$origin_dir/../Constraints/z-Zybo-Z7-Master-physical.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/../Constraints/z-Zybo-Z7-Master-physical.xdc"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property -name "file_type" -value "XDC" -objects $file_obj
