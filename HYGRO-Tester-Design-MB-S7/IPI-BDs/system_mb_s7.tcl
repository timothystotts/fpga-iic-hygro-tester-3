...
################################################################
# This is a generated script based on design: system_mb_s7
#
...
# source system_mb_s7_script.tcl
...
if { $bCheckIPs == 1 } {
   set list_check_ips "\ 
timothystotts.github.io:user:MuxSSD:1.0\
digilentinc.com:IP:PmodCLS:1.0\
...
proc create_root_design { parentCell } {
  ...
  set seg_gpio_jd [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 seg_gpio_jd ]

  set ssd_mux_jd [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 ssd_mux_jd ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.CLKOUT2_REQUESTED_OUT_FREQ {10.00000} \
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net MuxSSD_0_seg_gpio [get_bd_intf_ports seg_gpio_jd] [get_bd_intf_pins MuxSSD_0/seg_gpio]
  connect_bd_intf_net -intf_net MuxSSD_0_ssd_mux [get_bd_intf_ports ssd_mux_jd] [get_bd_intf_pins MuxSSD_0/ssd_mux]
  connect_bd_intf_net -intf_net PmodCLS_0_Pmod_out [get_bd_intf_ports ja] [get_bd_intf_pins PmodCLS_0/Pmod_out]
  ...
  connect_bd_intf_net -intf_net axi_gpio_1_GPIO2 [get_bd_intf_ports led_4bits] [get_bd_intf_pins axi_gpio_1/GPIO2]
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M04_AXI [get_bd_intf_pins MuxSSD_0/S00_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M04_AXI]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M05_AXI [get_bd_intf_pins PmodHYGRO_0/AXI_LITE_IIC] [get_bd_intf_pins microblaze_0_axi_periph/M05_AXI]
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M08_AXI [get_bd_intf_pins PmodCLS_0/AXI_LITE_SPI] [get_bd_intf_pins microblaze_0_axi_periph/M08_AXI]
  ...
  # Create port connections
  connect_bd_net -net CLK100MHZ_1 [get_bd_ports CLK100MHZ] [get_bd_pins mig_7series_0/sys_clk_i]
  connect_bd_net -net PmodHYGRO_0_I2C_Interrupt [get_bd_pins PmodHYGRO_0/I2C_Interrupt] [get_bd_pins microblaze_0_xlconcat/In2]
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins PmodCLS_0/ext_spi_clk] [get_bd_pins axi_quad_spi_0/ext_spi_clk] [get_bd_pins clk_wiz_0/clk_out1]
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_pins MuxSSD_0/ext_mux_clk] [get_bd_pins clk_wiz_0/clk_out2] [get_bd_pins rst_clk_wiz_0_50M/slowest_sync_clk]
  ...
  connect_bd_net -net microblaze_0_Clk [get_bd_pins MuxSSD_0/s00_axi_aclk] [get_bd_pins PmodCLS_0/s_axi_aclk] [get_bd_pins PmodHYGRO_0/s_axi_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_gpio_1/s_axi_aclk] [get_bd_pins axi_quad_spi_0/s_axi_aclk] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_intc/processor_clk] [get_bd_pins microblaze_0_axi_intc/s_axi_aclk] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_axi_periph/M01_ACLK] [get_bd_pins microblaze_0_axi_periph/M02_ACLK] [get_bd_pins microblaze_0_axi_periph/M03_ACLK] [get_bd_pins microblaze_0_axi_periph/M04_ACLK] [get_bd_pins microblaze_0_axi_periph/M05_ACLK] [get_bd_pins microblaze_0_axi_periph/M06_ACLK] [get_bd_pins microblaze_0_axi_periph/M07_ACLK] [get_bd_pins microblaze_0_axi_periph/M08_ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins mig_7series_0/ui_clk] [get_bd_pins rst_mig_7series_0_81M/slowest_sync_clk] [get_bd_pins smartconnect_0/aclk]
  ...
  connect_bd_net -net reset_1 [get_bd_ports reset] [get_bd_pins clk_wiz_0/resetn] [get_bd_pins mig_7series_0/sys_rst] [get_bd_pins rst_clk_wiz_0_50M/ext_reset_in]
  connect_bd_net -net rst_clk_wiz_0_50M_peripheral_reset [get_bd_pins MuxSSD_0/ext_mux_rst] [get_bd_pins rst_clk_wiz_0_50M/peripheral_reset]
  ...
  connect_bd_net -net rst_mig_7series_0_81M_peripheral_aresetn [get_bd_pins MuxSSD_0/s00_axi_aresetn] [get_bd_pins PmodCLS_0/s_axi_aresetn] [get_bd_pins PmodHYGRO_0/s_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins axi_quad_spi_0/s_axi_aresetn] [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins microblaze_0_axi_intc/s_axi_aresetn] [get_bd_pins microblaze_0_axi_periph/ARESETN] [get_bd_pins microblaze_0_axi_periph/M00_ARESETN] [get_bd_pins microblaze_0_axi_periph/M01_ARESETN] [get_bd_pins microblaze_0_axi_periph/M02_ARESETN] [get_bd_pins microblaze_0_axi_periph/M03_ARESETN] [get_bd_pins microblaze_0_axi_periph/M04_ARESETN] [get_bd_pins microblaze_0_axi_periph/M05_ARESETN] [get_bd_pins microblaze_0_axi_periph/M06_ARESETN] [get_bd_pins microblaze_0_axi_periph/M07_ARESETN] [get_bd_pins microblaze_0_axi_periph/M08_ARESETN] [get_bd_pins microblaze_0_axi_periph/S00_ARESETN] [get_bd_pins mig_7series_0/aresetn] [get_bd_pins rst_mig_7series_0_81M/peripheral_aresetn] [get_bd_pins smartconnect_0/aresetn]
  ...
  assign_bd_address -offset 0x44A10000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs PmodHYGRO_0/AXI_LITE_IIC/Reg0] -force
  assign_bd_address -offset 0x44A20000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs PmodHYGRO_0/AXI_LITE_TMR/Reg0] -force
